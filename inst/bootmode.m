...
%!
%! # Repeat function call systematically increasing the number of modes (M) by 1, 
%! # until the null hypothesis is accepted (i.e. H0 = 0)...
%!
%! [H2, P2, CRITVAL2] = bootmode(x,2,2000);
%! 
%! sprintf ('Summary of results:\n') 
%! sprintf ('H1 is %u with p = %.3g so reject the null hypothesis that there is 1 mode\n', H1, P1)
%! sprintf ('H2 is %u with p = %.3g so accept the null hypothesis that there are 2 modes\n', H2, P2)
%! 
