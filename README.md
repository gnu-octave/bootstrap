...
For an example of how to import (larger) data sets from a human-readable text file, like a comma-separated-value (CSV) file, see this [demonstration](https://gnu-octave.github.io/statistics-resampling/function/randtest2.html#5)
