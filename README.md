...
* `bootclust` performs balanced bootknife resampling of clustered data and calculates bootstrap bias, standard error and confidence intervals for any user defined-function of the data.
