...
You can try out the statistics-resampling package online either in Matlab ([![Open in MATLAB Online](https://www.mathworks.com/images/responsive/global/open-in-matlab-online.svg)](https://matlab.mathworks.com/open/github/v1?repo=gnu-octave/statistics-resampling&file=README.md)) or in Octave ([![Binder](https://mybinder.org/badge_logo.svg)](https://mybinder.org/v2/gh/acpennlab/statistics-resampling/master?labpath=statistics-resampling.ipynb)). Note that the first time you load use statistics-resampling online with Binder it will take a few minutes to build a docker image.  
